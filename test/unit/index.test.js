...
const classes = { SimulateUser, DebugUser };

Object.keys(classes).forEach(className => {
    const TestUser = classes[className];

    // Speed up tests
    TestUser.timeoutLimit = 5;
    TestUser.sleepTime = 0.1;
        ...
        describe('finders', () => {
            ...
            describe('find', () => {
                it('will wait to find an element', async () => {
                    ...
                    await new Promise(resolve => setTimeout(resolve, TestUser.timeoutLimit / 2));
